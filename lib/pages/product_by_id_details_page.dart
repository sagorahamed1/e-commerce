        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text("${products["name"]}",style: TextStyle(fontSize: 28,fontWeight: FontWeight.w700),),


              Text("Price ৳ ${products["price"]}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
              ...
              /// rating star
              Text("Customer Review",style: TextStyle(fontSize: 20),),
              Row(
                children: [
              ...
              ElevatedButton(onPressed: (){
                addToCartController!.addToCart(products);
                  ...
                  height: 60,
                  width: 130,
                  child: Image.asset("assets/add_to_card_image.png",fit: BoxFit.cover,)))
            ],
          ),
        ),
      ),
